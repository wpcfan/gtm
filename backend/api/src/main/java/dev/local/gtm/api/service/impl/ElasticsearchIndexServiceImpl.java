...
public class ElasticsearchIndexServiceImpl implements ElasticsearchIndexService {
    ...
    private <T, S, ID extends Serializable> void reIndexAll(Class<T> entityClass, Class<S> searchClass, MongoRepository<T, ID> mongoRepository, ElasticsearchRepository<S, ID> elasticsearchRepository) {
