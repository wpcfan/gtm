...
public class AuditEventConverter {
  ...
  /**
   * 将一组 PersistentAuditEvent 转换为 AuditEvent
   *
   * @param persistentAuditEvents 待转换事件列表
   * @return 转换后的事件列表
   */
  ...
  /**
   * 将一个 PersistentAuditEvent 转换为 AuditEvent
   *
  ...
  public AuditEvent convertToAuditEvent(PersistentAuditEvent persistentAuditEvent) {
    ...
    return new AuditEvent(Instant.from(persistentAuditEvent.getAuditEventDate()), persistentAuditEvent.getPrincipal(),
